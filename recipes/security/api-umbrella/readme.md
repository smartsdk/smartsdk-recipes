...
discovery, you will need to have expose the ports of the MongoDB server on the
...
Now, let's create the admin user in API Umbrella. As first thing,
...
Create a simple API to test that everything works:
...
After creating the API, you need to publish it:
...
Now you can issue a query to your API:
